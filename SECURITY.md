...
- password-protected portable profile exports
- profile and account validation during import
- host-authoritative multiplayer checks
- Fair Play violation handling
- host-local restrictions
- repository-wide multiplayer ban-list checks
- privacy-safe error and feedback reports

These protections reduce ordinary cheating and accidental exposure, but they are not a substitute for an authoritative server.

## Related documents

- **[Encrypted Profile Security](docs/PROFILE-SECURITY.md)**
- **[Security and Ban System](live/security/README.md)**
- **[Error System Architecture](live/docs/architecture/ERROR_SYSTEM.md)**
- **[Multiplayer Architecture](live/docs/architecture/MULTIPLAYER.md)**
